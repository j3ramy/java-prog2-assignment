...
public class FilePaths {
    ...
    public static final String NETFLIX_TITLES_PATH = "././resources/data/converted/netflix_titles.csv";
    public static final String DISNEY_PLUS_TITLES_PATH = "././resources/data/converted/disney_plus_titles.csv";
    public static final String AMAZON_PRIME_TITLES_PATH = "././resources/data/converted/amazon_prime_titles.csv";
