...
public class SearchMediumPanel extends JPanel implements IViewPanel {
    ...
    public void initActionListeners(){
        ...
        this.searchMediumButton.addActionListener((e) -> {
    ...
    public void setTranslations(){
        ...
        this.titleRadioButton.setText(appModel.getTranslation("label.reviewdata.medium_title"));
        this.genreRadioButton.setText(appModel.getTranslation("label.metadata.genre"));
        this.castRadioButton.setText(appModel.getTranslation("label.metadata.cast"));
    ...
    private boolean getMediums(){
        ...
        if(this.titleRadioButton.isSelected()){
            this.currentSearchResults = this.appView.getAppController().getAppModel().getMediumsByTitle(this.inputTextField.getText());
        }
